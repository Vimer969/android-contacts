...
import ru.yandex.practicum.contacts.presentation.sort.model.SortType; // <- импорт
...
public class SortTypeAdapter extends RecyclerView.Adapter<SortTypeAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder { // <- сделано public
